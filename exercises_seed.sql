-- Comprehensive exercise database with different equipment and muscle groups
-- This script adds a wide variety of exercises for all major muscle groups
-- Uses INSERT ... ON CONFLICT to avoid duplicates and preserve existing data

-- Chest Exercises
INSERT INTO exercises (name, muscle_group, equipment, user_id) VALUES 
-- Barbell
...
-- Bodyweight
('Chin-ups', 'Bizeps', 'Körpergewicht', NULL),
...
-- Bodyweight
('Dips', 'Trizeps', 'Körpergewicht', NULL),
...
-- Note: Since there's no unique constraint on name, we'll use a different approach
